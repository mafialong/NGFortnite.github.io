let vm = new Vue({
  ...
  created: function () {
    this.inputProps = [
      ...
      {
        title: "第二赛季结束[国际服]",      // 标题字符串 必填 目前最多支持12个汉字
        end_y: "2020",            // 结束的年份 必填 标准格式2019 不能写19
        end_m: "06",               // 结束的月份 必填 可以写成05或5均可 范围1~12
        end_d: "03",              // 结束的日 必填 可以写成05或5均可 范围1~(28,29,30,31)
        end_h: "17",              // 结束的小时 必填 标准24小时制 下午4点必须写成16；05也可写成5 范围0~23
        end_mi: "00",             // 结束的分钟 必填 05或5均可 范围0~59
        // 以上参数代表本活动标题为"第二赛季结束"，结束时间为"2020年06月03日 17:00"
      },
      // 创建一个新倒计时板的时候复制到这里结束
